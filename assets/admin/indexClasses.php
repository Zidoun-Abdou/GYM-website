...
<div class="container admin">
    <div class="row">
        <h1><strong>List of classes </strong><a href="insertClasses.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus"></span> Add</a></h1>
        <table class="table table-stripped table-bordered">
            ...
            $db = Database::connect();
            $statement = $db->query('SELECT classes.name, classes.max, classes.price, classes.id
                                              FROM   classes 
            ...
            while ($class = $statement->fetch())
            {
                ...
                echo '<td>' . $class['max'] . ' persons</td>';
                echo '<td>' . $class['price'] . ' $</td>';
                echo '<td width="300">';
                    echo '<a href="viewClasses.php?id=' . $class['id'] . '" class="btn btn-warning">verify</a>';
                    echo ' ';echo ' ';
                    echo '<a href="updateClasses.php?id=' . $class['id'] . '" class="btn btn-primary"> update</a>';
                    echo ' ';echo ' ';
                    echo '<a href="deleteClasses.php?id=' . $class['id'] . '" class="btn btn-danger"> delete</a>';
                echo '</td>';
                echo '</tr>';
            }
            ?>
