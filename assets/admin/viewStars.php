...
$db = Database::connect();
$statement = $db->prepare('SELECT persons.id, persons.image, persons.text1, persons.text2
                                                      FROM   persons
                                                      where persons.id = ?');
...
<div class="container">
    <br>
    <h1 class="text-center"><strong>See a star</strong></h1>
    <br>
    <div class="row">
        <div class="col-sm-6">
            ...
            <form action="">
                <div class="form-group">
                    <label>Name:</label><?php  echo ' ' . $item['text1']; ?>;
                </div>
                <div class="form-group">
                    <label>Description:</label><?php  echo ' ' . $item['text2']; ?>;
                </div>
                <div class="form-group">
