...
<div class="container admin">
    <div class="row">
        <h1><strong>List of features </strong><a href="insertFeatures.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus"></span> Add</a></h1>
        <table class="table table-stripped table-bordered">
            ...
            $db = Database::connect();
            $statement = $db->query('SELECT featurs.name, featurs.text, featurs.id
                                              FROM   featurs 
                                              ORDER BY featurs.id DESC    
                                    ');
            while ($class = $statement->fetch())
            {
                ...
                echo '<td width="300">';
                echo '<a href="viewFeatures.php?id=' . $class['id'] . '" class="btn btn-warning">verify</a>';
                echo ' ';echo ' ';
                echo '<a href="updateFeatures.php?id=' . $class['id'] . '" class="btn btn-primary"> update</a>';
                echo ' ';echo ' ';
                echo '<a href="deleteFeatures.php?id=' . $class['id'] . '" class="btn btn-danger"> delete</a>';
                echo '</td>';
                echo '</tr>';
            }
            ?>
